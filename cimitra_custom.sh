...
CUSTOM_LINK__ONE_DESCRIPTION="We Would Like to Hear From You"
CUSTOM_LINK_ONE_ADDRESS="http://grouplink.com/contact-us/"
CUSTOM_LINK_ONE_ENABLED_IN=1

CUSTOM_LINK_TWO_NAME="PowerShare"
CUSTOM_LINK__TWO_DESCRIPTION="Learn more about PowerShare"
...
CUSTOM_LINK__THREE_DESCRIPTION="A great site for PowerShell Recipes"
...
CUSTOM_LINK__FOUR_DESCRIPTION="A great site for Linux commands"
