...
sudo curl -sLJO ${PNG_DOWNLOAD_FILE}  2> /dev/null

sudo curl -sLJO ${SVG_DOWNLOAD_FILE}  2> /dev/null

sudo cp ./*.svg ${ICONS_DIRECTORY}   2> /dev/null

sudo cp ./*.png ${ICONS_DIRECTORY}   2> /dev/null
